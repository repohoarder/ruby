...
class ChangelogsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create changelog" do
    assert_difference('Changelog.count') do
      post changelogs_url, params: { changelog: { action: @changelog.action, notes: @changelog.notes, success: @changelog.success, user_id: @changelog.user_id } }
    end
  ...
  test "should update changelog" do
    patch changelog_url(@changelog), params: { changelog: { action: @changelog.action, notes: @changelog.notes, success: @changelog.success, user_id: @changelog.user_id } }
